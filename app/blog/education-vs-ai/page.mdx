...
I had never considered being a developer. By chance, I had played with a toy language as a kid - Lego's block-based language for programming Mindstorms robots - but I never thought of it as programming, just play. I went to UBC for engineering, which I imagined was a good general-purpose degree while I figured out what I wanted to do with my life. Since first year engineering is general, everyone has to take a C++ course. Within weeks, I fell in love with programming.
